...
fn test_single_scenario(
    ...
    let generated_message = match message_type {
        ...
        "MT291" => generate_sample::<swift_mt_message::messages::mt291::MT291>(
            message_type,
            Some(scenario_name),
        )
        .map(|msg| ParsedSwiftMessage::MT291(Box::new(msg))),
        ...
        "MT191" => generate_sample::<swift_mt_message::messages::mt191::MT191>(
            message_type,
            Some(scenario_name),
        )
        .map(|msg| ParsedSwiftMessage::MT191(Box::new(msg))),
    ...
    let mt_format = match &parsed_message {
        ...
        ParsedSwiftMessage::MT191(msg) => msg.to_mt_message(),
        ...
        ParsedSwiftMessage::MT291(msg) => msg.to_mt_message(),
