...
///
/// Specifies the number and total sum of debit transactions.
/// Used for control and verification of debit transaction totals.
...
///
/// Specifies the number and total sum of credit transactions.
/// Used for control and verification of credit transaction totals.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, SwiftField)]
pub struct Field90C {
