...
| **MT192** | request_cancellation | Cancellation request | Payment cancellation | Cancel payment request | 11R, 20, 21, 79 | ✅ | ✅ | ✅ | ✅ |
| **MT196** | answer_cancellation | Cancellation answer | Cancel response | Cancellation outcome | 20, 21, 11R, 76, 79 | ✅ | ✅ | ✅ | ✅ |
...
| **MT210** | expected_incoming_funds | Notice to receive | Expected funds | Pre-notification | 20, 21, 25, 30, 32B, 50, 52A | ✅ | ✅ | ✅ | ✅ |
| **MT292** | fi_cancellation_request | FI cancellation | Bank-to-bank cancel | FI cancel request | 11R, 20, 21, 79 | ✅ | ✅ | ✅ | ✅ |
...
| **MT299** | cbpr_payment_response | CBPR+ response | Cross-border response | CBPR+ compliant response | 20, 21, 79 | ✅ | ✅ | ✅ | ✅ |
...
| **MT940** | repeated_sequence_issues | Sequence issues test | Testing edge cases | Repeated sequences | 20, 25, 28C, 60F, 61 (multiple), 62F | ✅ | ✅ | ✅ | ✅ |
...
- Full test suite (80 scenarios × 100 samples): ~30 seconds
- Single scenario (100 samples): ~0.5 seconds
- Parsing rate: ~40,000 messages/second
